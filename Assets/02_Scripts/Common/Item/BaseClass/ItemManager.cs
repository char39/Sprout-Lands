...
{
    internal readonly static Dictionary<int, ToolItem> toolItem;
    internal readonly static Dictionary<int, FarmingPlantItem> farmingPlantItem;
    internal readonly static Dictionary<int, FruitItem> fruitItem;
    internal readonly static Dictionary<int, EggItem> eggItem;
    internal readonly static Dictionary<int, MilkItem> milkItem;
    ...
    public static Item GetItem(int id, int quantity = 1)
    {
        ToolItem toolItem = GetToolItem(id, quantity);
        if (toolItem != null) return toolItem;
        FarmingPlantItem farmingPlantItem = GetFarmingPlantItem(id, quantity);
        if (farmingPlantItem != null) return farmingPlantItem;
        FruitItem fruitItem = GetFruitItem(id, quantity);
        if (fruitItem != null) return fruitItem;
        EggItem eggItem = GetEggItem(id, quantity);
        if (eggItem != null) return eggItem;
        MilkItem milkItem = GetMilkItem(id, quantity);
        if (milkItem != null) return milkItem;
    ...
    {
        if (toolItem.TryGetValue(id, out ToolItem item))
        {
    ...
    {
        if (farmingPlantItem.TryGetValue(id, out FarmingPlantItem item))
        {
            item.SetStack(quantity);
            return item;
        }
    ...
    {
        if (fruitItem.TryGetValue(id, out FruitItem item))
        {
            item.SetStack(quantity);
            return item;
        }
    ...
    {
        if (eggItem.TryGetValue(id, out EggItem item))
        {
            item.SetStack(quantity);
            return item;
        }
    ...
    {
        if (milkItem.TryGetValue(id, out MilkItem item))
        {
            item.SetStack(quantity);
            return item;
        }
