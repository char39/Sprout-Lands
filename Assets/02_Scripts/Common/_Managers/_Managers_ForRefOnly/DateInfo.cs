...
public class DateInfo : MonoBehaviour
{
    ...
    {
        // (아침 6시 ~ 저녁 12시) z축 회전값
        float TimeNormal = (GameTime - GameTimeRule.GameTimeRatio * Hour.AM_6) / (GameTimeRule.GameTimeRatio * Hour.PM_6);
    ...
    private void UpdateTimeState()
    {
        ...
        if (GameTime > GameTimeRule.GameTimeRatio * Hour.PM_6)
            timeState = TimeState.Night;
        else if (GameTime > GameTimeRule.GameTimeRatio * Hour.AM_9)
