...
public partial class GameManager
{
    public class GM_DateInfo : MonoBehaviour
    {
        ...
        {
            // (아침 6시 ~ 저녁 12시) z축 회전값
            float TimeNormal = (GameTime - GameTimeRule.GameTimeRatio * 6) / (GameTimeRule.GameTimeRatio * 18);
        ...
        private void UpdateTimeState()
        {
            ...
            if (GameTime > GameTimeRule.GameTimeRatio * 18)
                timeState = TimeState.Night;
            else if (GameTime > GameTimeRule.GameTimeRatio * 9)
