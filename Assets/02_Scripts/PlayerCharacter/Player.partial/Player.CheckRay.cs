...
public partial class Player
{
    ...
    private List<Item> GetItems() => GM.DATA.inven.GetAllItems();
    private int GetSelectedSlotNow() => GetItems()[(int)GM.DATA.slotSelect.slotPos - 1].ID;
    ...
    private void SetFindTileObjectPos()
    {
        ...
        Item item = GetItems()[(int)GM.DATA.slotSelect.slotPos - 1];
